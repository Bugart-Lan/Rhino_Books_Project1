...
Since we haven't deploy it, in order for you to try, download it and open <strong>cmd</strong> type `flask run`, paste the <strong>url</strong> to the blowser, create a account (it's simple and take less than 30 seconds), and enjoy!
